...
bounds = Bounds([14, 0.2, 250, 0.05, 100], [19, .07, 800, 0.12, 290])
...
x0 = [17.5, 0.70, 455.0, 0.07, 288.0] #parachute, wheel radius, chas mass, gear diam, fuel mass
...
edl_system['team_name'] = 'Very fast kinda furious'  # change this to something fun for your team (or just your team number)
